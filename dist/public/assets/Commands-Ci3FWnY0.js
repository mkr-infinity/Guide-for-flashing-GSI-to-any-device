import{j as t}from"./index-CdaFwQS8.js";import{C as o}from"./CodeBlock-CRRGCP8Q.js";import"./check-Dpi9-5Rj.js";function i(){return t.jsxs("div",{className:"space-y-6",children:[t.jsxs("div",{className:"mb-8",children:[t.jsx("h1",{className:"text-4xl font-extrabold tracking-tight",children:"All Commands"}),t.jsx("p",{className:"text-lg text-muted-foreground mt-2",children:"The cheat sheet. For when you've done this before and just want the copy-paste."})]}),t.jsxs("div",{className:"prose dark:prose-invert max-w-none prose-emerald",children:[t.jsx("h3",{children:"The full flow"}),t.jsx(o,{code:`# 1. Reboot to bootloader
